window.addEventListener("load", function(){
        ...
        settings: {
            layout: {
                ...
                logo: {
                    ...
                    darkLogo: '/Users/yassinebehilil/Desktop/laravel_projects/tester/public/src/assets/img/logo.svg',
                    lightLogo: '/Users/yassinebehilil/Desktop/laravel_projects/tester/public/src/assets/img/logo2.svg'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '/Users/yassinebehilil/Desktop/laravel_projects/tester/public/src/assets/img/logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '/Users/yassinebehilil/Desktop/laravel_projects/tester/public/src/assets/img/logo2.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
