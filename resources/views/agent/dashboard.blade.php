                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="action-btns">
                                                                <a href="{{ 'agent/contracts/show/'.$contract->id }}" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="View">
