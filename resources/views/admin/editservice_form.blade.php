                    ...
                    <div class="row mb-3">
                      ...
                      <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form class="section general-info" method="POST" action="{{ route('admin.services.update', ['id' => $service->id]) }}">
                                        @csrf 
                                        @method("PUT")
                                        <div class="info">
                                            <h6 class=""></h6>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3 @error('name') is-invalid @enderror" name="name" id="name" placeholder="Full Insurance" value="{{ $service->name }}" required>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" step="0.001" class="form-control mb-3 @error('price') is-invalid @enderror" name="price" id="price" placeholder="300" min="0" value="{{ $service->price }}" required>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-3 @error('type') is-invalid @enderror" name="type" id="type" placeholder="Health Insurance" value="{{ $service->type }}" required>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control mb-3 @error('description') is-invalid @enderror" name="description" 
                                                                            placeholder="Here is the company description" rows="4" required>{{ $service->description }}</textarea>
